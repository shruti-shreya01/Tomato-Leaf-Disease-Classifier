...
# Path to the model architecture (Pickle file)
pickle_model_path = "potato_pickle_final (1).pkl"  # Replace with your actual pickle file path
# Path to the model weights
model_weights_path = "model_weights.weights.h5"

# Load the model architecture from pickle file
with open(pickle_model_path, 'rb') as f:
    model = pickle.load(f)

# Load the model weights
if os.path.exists(model_weights_path):
    model.load_weights(model_weights_path)  # Load the Keras model weights
else:
